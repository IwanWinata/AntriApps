...
<div class="container">
    <form id="ambilNomorForm" action="/AntriApps/AntrianServlet" method="post">
        ...
        <button class="form-button" type="button" onclick="ambilNomor()">Ambil Nomor Antrian</button>
    </form>

    <form id="panggilNomorForm" action="/AntriApps/AntrianServlet" method="post">
        <input type="hidden" name="action" value="panggil">
        <button class="form-button" type="button" onclick="panggilNomor()">Panggil Nomor Antrian</button>
    </form>
